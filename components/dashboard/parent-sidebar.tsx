            ...
            return (
              ...
              >
                ...
                >
                  {isActive && (
                    <motion.div
                      className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-orange-500 to-orange-600 rounded-r-full shadow-lg shadow-orange-500/30"
                    ...
                    <motion.div
                      className={cn(
                        ...
                        isActive
                          ...
                          : "bg-gray-100/60 group-hover:bg-gray-100 group-hover:shadow-sm",
                      )}
                  ...
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500/0 to-orange-500/0 group-hover:from-orange-500/5 group-hover:to-transparent transition-all duration-300 pointer-events-none" />
                </Link>
              </motion.div>
            );
          })}
