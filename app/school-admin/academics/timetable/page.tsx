...
export default function TimetablePage() {
  ...
  const loadTimetables = async () => {
    setLoading(true);
    try {
      const params = new URLSearchParams({ schoolId: "school-id-here" });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/school-admin/academics/timetable/periods">
            <Button variant="outline">
              <Clock className="mr-2 h-4 w-4" />
              Manage Periods
            </Button>
          </Link>
          <Link href="/school-admin/academics/timetable/rooms">
            <Button variant="outline">
              <Grid3x3 className="mr-2 h-4 w-4" />
              Manage Rooms
            </Button>
          </Link>
          <Link href="/school-admin/academics/timetable/substitutions">
            <Button variant="outline">
              <Users className="mr-2 h-4 w-4" />
              Substitutions
            </Button>
          </Link>
          <Link href="/school-admin/academics/timetable/create">
                ...
                <motion.div key={timetable.id} variants={item}>
                  <Card className="p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-center space-x-2">
                      <Link
                        href={`/school-admin/academics/timetable/${timetable.id}`}
                        className="flex-1"
                      >
                      ...
                      <Link
                        href={`/school-admin/academics/timetable/${timetable.id}/edit`}
                        className="flex-1"
                      >
                        <Button variant="outline" className="w-full" size="sm">
