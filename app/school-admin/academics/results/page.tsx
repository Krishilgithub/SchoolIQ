    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/school-admin/academics/results/analytics">
            <Button variant="outline">
              <BarChart3 className="mr-2 h-4 w-4" />
              Analytics
            </Button>
          </Link>
          <Link href="/school-admin/academics/results/report-cards">
            <Button variant="outline">
              <FileText className="mr-2 h-4 w-4" />
              Report Cards
            </Button>
          </Link>
          <Link href="/school-admin/academics/results/calculate">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
          <Link href="/school-admin/academics/results/rankings">
